...
| `JWT_AUDIENCE` | ✅ Yes | `https://velocify-work.vercel.app` | Your frontend URL |
| `LANGCHAIN_API_KEY` | ✅ Yes | `gsk-abc123...` | Groq API key from https://console.groq.com/keys |
| `CORS_ALLOWED_ORIGINS` | ✅ Yes | `https://velocify-work.vercel.app;https://velocify-staging.vercel.app` | Semicolon-separated list of frontend URLs |
